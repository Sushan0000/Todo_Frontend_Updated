...
var _Todos_instances,
	_Todos_backend_url,
	_Todos_readJson,
	_Todos_addToArray,
	_Todos_removeFromArray;
	...
	constructor(url) {
		...
		this.removeTask = (id) => {
			return new Promise((resolve, reject) =>
				__awaiter(this, void 0, void 0, function* () {
					fetch(
						__classPrivateFieldGet(this, _Todos_backend_url, "f") +
							"/delete/" +
							id,
						{
							method: "delete",
...
(_Todos_backend_url = new WeakMap()),
	(_Todos_instances = new WeakSet()),
	(_Todos_readJson = function _Todos_readJson(tasksAsJson) {
